...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-base-200 dark:bg-gray-900">
      <div className="card bg-white dark:bg-gray-800 w-96 shadow-xl border border-gray-200 dark:border-gray-700">
        <figure className="px-10 pt-10">
          <img
            ...
            alt="User"
            className="rounded-full w-32 h-32 border-4 border-emerald-500 object-cover"
          />
        </figure>
